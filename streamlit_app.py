...
def run_UI():
    ...
    with st.expander("Scalability"):
        ...
        ax.set_ylabel("Average Performance", labelpad=8.,fontsize=14,font = "sans_serif")
        ax.set_ylim(0.,1.55)
        ax.set_xlabel("Number of Tasks", labelpad=11.,fontsize=14,font = "sans_serif")
        ax2 = ax.twinx()
        ...
        ax2.set_ylabel("Growing Factor",rotation=270,labelpad=25., fontsize=14,font = "sans_serif")
        ax2.set_ylim(1,13)
        ax2.grid(False)
