...
def run():
    ...
    with st.expander("Scalability"):
        row_2_1,row_2_2 = st.columns([2,1])
        with row_2_1:
            ...
            It is defined as the ration between the number of parameters of the policy at last task and at first task. We made an ablation study
    ...
    with st.expander("Plasticity"):
        row_3_1,row_3_2 = st.columns([2,1])
        with row_3_1:
            txt = """
